...
Cropped rendering is a **multi-pass process**, built on top of the existing diff-highlight machinery (`\g__tf_mode_int` dispatch: `0`=inactive, `1`=record, `2`=render, `3`=clean, `4`=figure; crop adds `5`=scan and `6`=line-count):
